      ...
      <section id="dishes" className="dishes-section">
        ...
        <div className="container">
          ...
          <div className="dishes-grid">
            {[
              { img: 'https://assets.cdn.filesafe.space/ftiLAicHGn0i3cqS3Rye/media/69c5fbd8146bc51f9eec8ca7.jpg', name: 'Rib Eye', price: '₡17,500', desc: 'Premium cut served sizzling on cast iron with rosemary potatoes, sweet plantain, jalapeño, and chimichurri.', badge: { text: "Chef's Choice", color: 'orange' } },
              ...
              { img: 'https://assets.cdn.filesafe.space/ftiLAicHGn0i3cqS3Rye/media/6a148ca3e05851175c7f83db.jpg', name: 'Cahuita Chicken', price: '₡9,100', desc: 'Grilled chicken in rich coconut milk, thyme, and chili pepper sauce with vegetables and mashed potatoes.' },
              ...
              { img: 'https://assets.cdn.filesafe.space/ftiLAicHGn0i3cqS3Rye/media/69ec4de6b0e5e2bb7f933572.webp', name: 'Flambéed Pineapple', price: '₡4,700', desc: 'Caramelized pineapple in orange and cinnamon sauce, flamed in orange liquor, topped with vanilla ice cream.', badge: { text: 'Premium', color: 'orange' } },
            ].map((dish) => (
            ...
            {[
              {
                ...
                drinks: ['Margarita Clásica', 'Wild Passion Margarita', 'Margarita de Mango'],
                highlight: false,
              },
              {
                ...
                drinks: ['Pura Vida', 'Julia', 'A Cachete'],
                highlight: true,
              },
              {
                img: 'https://assets.cdn.filesafe.space/ftiLAicHGn0i3cqS3Rye/media/69c734202e89d8e97f5f1526.jpg',
                title: 'The Classics',
                desc: 'Timeless cocktails crafted with precision — the perfect companions for a relaxed evening under the jungle sky.',
                drinks: ['Mojito', 'Piña Colada', 'Old Fashioned', 'Negroni'],
                highlight: false,
              },
            ].map((c) => {
              const card = (
