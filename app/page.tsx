          ...
          <div className="exp-cards">
            ...
            <div className="exp-card fade-up">
              <div className="exp-card-inner reverse">
                <div className="exp-img-side">
                  <div className="exp-img-frame"></div>
                  <div className="exp-img-wrap" style={{ background: '#111111' }}>
                    <Image src="https://assets.cdn.filesafe.space/ftiLAicHGn0i3cqS3Rye/media/6a31af9c8892600038a93ac8.png" alt="Signature Cocktails" width={800} height={600} loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
