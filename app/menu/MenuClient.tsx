...
const enFood = {
  ...
  seafood: [
    ...
    { name: 'Trout With Creamy', price: '₡12,400', desc: 'Costa Rican trout in creamy sauce and shrimp served with artichoke rice and cherry tomato.', photo: CDN + '6a34a54bde4900e889a955ab.jpg' },
  ...
  steaks: [
    ...
    { name: 'Churrasco', price: '₡15,600', photo: CDN + '6a34a5e26a6dd1b69a190855.jpg' },
    ...
    { name: 'Surf And Turf', price: '₡31,900', photo: CDN + '6a36fff11c5d711b35b9bb38.jpg' },
  ],
  ...
  vegetarian: [
    ...
    { name: 'Parmesan Eggplant', price: '₡8,500', desc: 'Encrusted eggplant with Parmesan cheese served with tomato sauce, capers, olives, and house salad.', photo: CDN + '6a37000cf2131051b815bea8.jpg' },
...
const esFood = {
  ...
  seafood: [
    ...
    { name: 'Trucha en Salsa Cremosa', price: '₡12,400', desc: 'Trucha costarricense en salsa cremosa con camarones, servida con arroz de alcachofas y tomates cherry.', photo: CDN + '6a34a54bde4900e889a955ab.jpg' },
  ...
  vegetarian: [
    ...
    { name: 'Berenjena Parmesana', price: '₡8,500', desc: 'Berenjena encostrada con queso Parmesano, servida con salsa de tomate, alcaparras, aceitunas y ensalada de la casa.', photo: CDN + '6a37000cf2131051b815bea8.jpg' },
...
export default function MenuClient({ lang = 'en' }: { lang?: 'en' | 'es' }) {
  ...
  const banners = {
    ...
    steaks: CDN + '6a36fff11c5d711b35b9bb38.jpg',
    vegetarian: CDN + '6a37000cf2131051b815bea8.jpg',
  ...
  return (
    <>
                  ...
                  {tikis.map((c) => c.photo ? (
                    ...
                    >
                      <div className="nm-cktl-photo-wrap">
                        <Image src={c.photo} alt={c.name} width={800} height={1000} style={{ width: '100%', height: 'auto', display: 'block' }} />
      ...
      <div className="nm-sticky-reserve">
        <a
          href={`https://wa.me/50624790707?text=${encodeURIComponent(
            lang === 'es'
              ? 'Hola! Quisiera reservar una mesa en Nanku.'
              : "Hi! I'd like to reserve a table at Nanku."
          )}`}
          target="_blank"
          rel="noopener noreferrer"
          className="nm-sticky-reserve-btn"
        >
