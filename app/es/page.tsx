              ...
              <div className="exp-card-inner">
                <div className="exp-img-side">
                  ...
                  <div className="exp-img-wrap">
                    <img src="https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=800&q=80" alt="Música en Vivo" loading="lazy" />
            ...
            <div className="exp-card fade-up">
              <div className="exp-card-inner reverse">
                <div className="exp-img-side">
                  <div className="exp-img-frame"></div>
                  <div className="exp-img-wrap">
                    <img src="https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&q=80" alt="Cócteles de la Casa" loading="lazy" />
            ...
            <div className="exp-card fade-up">
              <div className="exp-card-inner">
                <div className="exp-img-side">
                  <div className="exp-img-frame"></div>
                  <div className="exp-img-wrap">
                    <img src="https://images.unsplash.com/photo-1544025162-d76694265947?w=800&q=80" alt="Cortes Premium" loading="lazy" />
                    <div className="exp-img-gradient" style={{ background: 'linear-gradient(to right,rgba(17,17,17,0.7) 0%,transparent 50%),linear-gradient(to top,rgba(17,17,17,0.5) 0%,transparent 40%)' }}></div>
